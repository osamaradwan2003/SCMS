...
-- AlterTable
ALTER TABLE "Bank" ALTER COLUMN "userId" DROP NOT NULL;
...
-- AlterTable
ALTER TABLE "EmployeeAttendance" ALTER COLUMN "userId" DROP NOT NULL;

-- AlterTable
ALTER TABLE "ExpenseType" ALTER COLUMN "userId" DROP NOT NULL;

-- AlterTable
ALTER TABLE "Guardian" ALTER COLUMN "userId" DROP NOT NULL;

-- AlterTable
ALTER TABLE "IncomeType" ALTER COLUMN "userId" DROP NOT NULL;

-- AlterTable
ALTER TABLE "MessageLog" ALTER COLUMN "senderId" DROP NOT NULL;

-- AlterTable
ALTER TABLE "Payroll" ALTER COLUMN "userId" DROP NOT NULL;

-- AlterTable
ALTER TABLE "Student" ALTER COLUMN "userId" DROP NOT NULL;

-- AlterTable
ALTER TABLE "StuednAttendance" ALTER COLUMN "userId" DROP NOT NULL;
...
-- AlterTable
ALTER TABLE "WeeklyReport" ADD COLUMN     "userId" UUID;
...
-- AddForeignKey
ALTER TABLE "StuednAttendance" ADD CONSTRAINT "StuednAttendance_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "IncomeType" ADD CONSTRAINT "IncomeType_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
